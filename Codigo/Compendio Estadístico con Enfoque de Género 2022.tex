...
\begin{document}
	...
	\INEchaptercarta{Educación}{En este capítulo gracias a la recolección de datos administrativos del INE y de la Encuesta Nacional de Egresos e Ingresos -ENEI- que identifica datos estadísticos importantes en cuanto al nivel educativo a identificar datos de matriculación, deserción, tasa de escolaridad.}
	...
	\INEchaptercarta{Participación sociopolítica}{En este capítulo se encontrarán datos que reflejan la participación de las mujeres en ámbitos públicos tales como Consejos de Desarrollo, el Organismo Legislativo, el Organismo Judicial, a nivel municipal.}
