...
\begin{document}
	...
	\INEchaptercarta{Educación}{En este capítulo representa la recolección de datos administrativos del INE y de la Encuesta Nacional de Egresos e Ingresos 2022 -ENEI- se identifican datos estadísticos importantes en cuanto al nivel educativo con datos de matriculación, deserción y tasa de escolaridad.}
	\input{Capitulos/capitulo3.tex}

	\INEchaptercarta{Economía y trabajo}{Este capítulo muestra datos relevantes del aporte de las mujeres de la Población Económicamente Activa (PEA) y la Población Ocupada (PO) que dan al desarrollo económico en la sociedad guatemalteca además de datos relevantes en el ámbito laboral. Coadyuvando con estos indicadores a dar elementos para la Política Nacional de Promoción y Desarrollo de las Mujeres guatemaltecas.}
