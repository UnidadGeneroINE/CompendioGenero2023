...
\path[fill=fillColor] (186.32,  6.16) rectangle (196.38, 16.22);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (289.08,198.74);
\definecolor{drawColor}{RGB}{0,0,0}
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.80] at (203.54,  8.06) {Hombres};
\end{scope}
