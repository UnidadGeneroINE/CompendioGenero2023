...
\path[fill=fillColor] (104.49,182.52) rectangle (114.55,192.58);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (289.08,198.74);
\definecolor{fillColor}{gray}{0.95}
...
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (292.08,198.74);
\definecolor{fillColor}{RGB}{116,112,200}
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.80] at (120.71,184.43) {Mujeres};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (289.08,198.74);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.80] at (165.25,184.43) {Hombres};
\end{scope}
