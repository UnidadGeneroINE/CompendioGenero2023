...
\newtcolorbox{encabezadoimpar}{
	...
	skin=enhancedmiddle,
	nobeforeafter,
	watermark graphics=Plantilla/ai_Cintillo_Derecha_DCE.pdf,
%	watermark opacity=1.0,
	watermark overzoom=1.0,
...
\newtcolorbox{encabezadopar}{
	...
	skin=enhancedmiddle,
	nobeforeafter,
	watermark graphics=Plantilla/ai_Cintillo_izquierda_DCE.pdf,
	watermark opacity=1.0,
	watermark overzoom=1.0,
...
\begin{tabular}{p{4.75in}}
 \fontsize{2.5in}{3em}\selectfont\color{white}\centering\textbf{\thechapter}\\[1cm]
